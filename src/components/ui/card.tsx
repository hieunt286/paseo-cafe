...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "surface-panel group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-none py-(--card-spacing) [--card-spacing:--spacing(4)] has-[>img:first-child]:pt-0 has-data-[slot=card-footer]:pb-0 data-[size=sm]:has-data-[slot=card-footer]:pb-0 data-[size=sm]:[--card-spacing:--spacing(3)] *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("type-label font-heading", className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("type-meta text-muted-foreground", className)}
      {...props}
    />
  )
}
